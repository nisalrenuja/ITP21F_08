...
import DisplayNotice from "../../modules/AdminModules/DisplayNotice";

const Displaynotice = ({ history, match }) => {
  let userRole = "";
      ...
      {selectedMenuOption !== "" ? (
        <Container>
          {selectedMenuOption === "User Executive" ? (
            ...
            <DisplayNotice dataFromParent={match.params.existingNotices} />
